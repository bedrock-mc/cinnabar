module github.com/hashimthearab/rust-mcbe/tools/fixturegen
...
replace github.com/sandertv/gophertunnel => github.com/hashimthearab/gophertunnel v1.25.3-0.20260710063825-9948b1729395
