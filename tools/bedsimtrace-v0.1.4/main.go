// Command bedsimtrace-v0.1.4 emits the canonical v0.1.4 liquid JSONL fixture.
...
func main() {
	if len(os.Args) != 1 {
		fmt.Fprintln(os.Stderr, "usage: bedsimtrace-v0.1.4")
		os.Exit(2)
	}
...
// liquidExitScripts records the bounded v0.1.4 liquid evidence slice.
