...
| VPA-112 | `2ae01aed0e98b0fa8d23ca6e630f843183dd21ab` | `c4ccc81c`, `5cbfbcea` | The player preview no longer appears in ordinary gameplay or any storage lifecycle state, while personal inventory retains it; coordinator app suites, formatting, strict Clippy, architecture, and fresh Sol-high re-review passed. Local only, not pushed. |
