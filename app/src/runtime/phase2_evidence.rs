...
fn stage_counters_json(stages: PublicationStageCounters) -> Value {
    json!({
        ...
        "resync_requests_sent": stages.resync_requests_sent,
        "resync_responses_completed": stages.resync_responses_completed,
        "resync_retry_exhausted": stages.resync_retry_exhausted,
