...
pub(crate) fn world_publication_snapshot_marker(
    ...
    format!(
        ...
        serde_json::json!({
            ...
            "resync_requests_sent": stats.phase2_stages.resync_requests_sent,
            "resync_responses_completed": stats.phase2_stages.resync_responses_completed,
            "resync_retry_exhausted": stats.phase2_stages.resync_retry_exhausted,
