...
pub use entity::{
    ...
    EntityGeometryFaceUvs, EntityGeometryInheritance, EntityGeometryLocator, EntityGeometryScalar,
    ...
    MAX_ENTITY_GEOMETRY_LOCATORS, MAX_ENTITY_GEOMETRY_NAME_BYTES, MAX_ENTITY_GEOMETRY_SCALAR,
