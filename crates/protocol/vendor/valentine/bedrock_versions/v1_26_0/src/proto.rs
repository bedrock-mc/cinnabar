...
impl crate::bedrock::codec::BedrockSized for BossEventPacket {
    fn encoded_size(&self) -> usize {
        let mut size = 0usize;
        size += crate::bedrock::codec::BedrockSized::encoded_size(
            &crate::bedrock::codec::ZigZag64(self.boss_entity_id),
        );
        size += crate::bedrock::codec::BedrockSized::encoded_size(&self.type_);
        size += match &self.content {
            Some(_v) => match _v {
                BossEventPacketContent::Query(_v) => {
                    crate::bedrock::codec::BedrockSized::encoded_size(_v)
                }
                BossEventPacketContent::RegisterPlayer(_v) => {
                    crate::bedrock::codec::BedrockSized::encoded_size(_v)
                }
                BossEventPacketContent::SetBarProgress(_v) => {
                    crate::bedrock::codec::BedrockSized::encoded_size(_v)
                }
                BossEventPacketContent::SetBarTitle(_v) => {
                    crate::bedrock::codec::BedrockSized::encoded_size(_v)
                }
                BossEventPacketContent::ShowBar(_v) => {
                    crate::bedrock::codec::BedrockSized::encoded_size(_v)
                }
                BossEventPacketContent::Texture(_v) => {
                    crate::bedrock::codec::BedrockSized::encoded_size(_v)
                }
                BossEventPacketContent::UnregisterPlayer(_v) => {
                    crate::bedrock::codec::BedrockSized::encoded_size(_v)
                }
                BossEventPacketContent::UpdateProperties(_v) => {
                    crate::bedrock::codec::BedrockSized::encoded_size(_v)
                }
            },
            None => 0usize,
...
impl crate::bedrock::codec::BedrockSized for LevelSoundEventPacket {
    fn encoded_size(&self) -> usize {
        let mut size = 0usize;
        size += crate::bedrock::codec::BedrockSized::encoded_size(&self.sound_id);
        size += crate::bedrock::codec::BedrockSized::encoded_size(&self.position);
        size += crate::bedrock::codec::BedrockSized::encoded_size(
...
impl crate::bedrock::codec::BedrockSized for DebugRendererPacket {
    fn encoded_size(&self) -> usize {
        let mut size = 0usize;
        size += {
...
impl crate::bedrock::codec::BedrockSized for GraphicsOverrideParameterPacket {
    fn encoded_size(&self) -> usize {
        ...
        size += 4usize;
        size += crate::bedrock::codec::BedrockSized::encoded_size(&self.vec_3_value);
        size += {
...
impl crate::bedrock::codec::BedrockSized for ClientboundDataDrivenUiCloseAllScreensPacket {
    fn encoded_size(&self) -> usize {
        0usize
    }
}
