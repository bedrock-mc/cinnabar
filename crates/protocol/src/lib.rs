...
pub use inventory::{
    ...
    ItemStackResponseEvent, MAX_CONTAINER_SLOTS, MAX_ITEM_NBT_BYTES, MAX_RESPONSE_CONTAINERS,
    ...
    item_stack_request_packet, normalize_authority, normalize_container_close,
